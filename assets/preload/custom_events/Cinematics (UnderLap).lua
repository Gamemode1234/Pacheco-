...
HudAssets = {'healthBarBG','healthBar','scoreTxt','iconP1','iconP2','timeBar','newtimeBarBG','timeTxt'}
Index = 1

function onCreatePost()
--
    makeLuaSprite('UpperBar(UnderLap)', 'barshit', -110, -350)
	--makeGraphic('UpperBar(UnderLap)', 1500, 350, "000000")
	setObjectCamera('UpperBar(UnderLap)', 'HUD')
	addLuaSprite('UpperBar(UnderLap)', false)

    makeLuaSprite('LowerBar(UnderLap)', 'barshit', -110, 720)
